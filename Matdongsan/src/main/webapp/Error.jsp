...
<body>
    ...
    style="text-align:center">                                                                                     
	   ...
	   <br>
        ...
        <input type="button" onClick="location.href='login.jsp'" class="btn_two" value="L O G I N" />
        <input type="button" onClick="location.href='member_search.jsp'" class="btn_three" value="회원정보 찾기" />
      </form>
