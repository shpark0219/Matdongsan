   ...
   <div class="section">
      <div class="container">
         <div class="row">
            <div class="col-lg-4 mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
               <div class="contact-info">
                  ...
                  <div class="address mt-2">
                     <i class="icon-room"></i>
                     <h4 class="mb-2">주소 :</h4>
                     <p>전라남도 순천시 중앙로 260 <br> 5층 스마트인재개발원</p>
                  </div>
            ...
            <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200" style="margin-left: 0px; ">
               <form action="SuggestCon">
                  <div class="row">
                     <div class="col-12 mb-3">
                        <input type="email" name="sg_email" class="form-control" placeholder="E-mail">
                     </div>
                     <div class="col-12 mb-3">
                        <textarea name="sg_title" id="" cols="30" rows="1" class="form-control" placeholder="제목을 입력하세요."></textarea>
                     </div>
                     <div class="col-12 mb-3">
                        <textarea name="sg_content" id="" cols="30" rows="7" class="form-control" placeholder="건의사항을 입력하세요."></textarea>
                     </div>
