			...
			<div class="menu-bg-wrap">
				<div class="site-navigation">
					...
					<ul
						...
						<li class="has-children"><a>부동산계산기</a>
							<ul class="dropdown">
		...
		<div id="a">
			...
			<!-- <div class="col-md-6 mb-3">
				<div class="input-group">
					...
					<input type="number" class="form-control number-helper" id="amount"
						name="amount" placeholder="대출 희망금액" value="">
			...
			<div class="col-md-6 mb-3" style="margin-top: 10px;">
				<div class="input-group">
					...
					<input type="number" class="form-control number-helper" id="deposit"
						name="deposit" placeholder="대출 희망금액" value="">
					<div class="input-group-append">
						<span class="input-group-text">만원</span>
					</div>
				</div>
			...
			<div class="col-md-6 mb-3">
				<div class="input-group">
					...
					<input type="number" class="form-control number-helper" id="price"
						name="price" placeholder="평균 시세(감정가)" value="">
					<div class="input-group-append">
						<span class="input-group-text">만원</span>
					</div>
				</div>
			...
			<div class="col-md-6 mb-3">
				<div class="input-group">
					<div class="input-group-prepend">
						<span class="input-group-text">선순위채권</span>
					</div>
					<input type="number" class="form-control number-helper"
						id="seniorBond" name="seniorBond" placeholder="선순위 대출 등" value="">
					<div class="input-group-append">
						<span class="input-group-text">만원</span>
					</div>
				</div>
				<span class="sr-only">기존 대출 등이 있는 경우. 근저당은 채권최고액 기준으로 입력</span>
			</div>
		...
		<div id="b">
			...
			<div class="col-md-6 mb-3" style="margin-top: 10px;">
				<div class="input-group">
					...
					<input type="number" class="form-control number-helper" id="deposit"
						name="deposit" placeholder="전월세의 보증금" value="">
					<div class="input-group-append">
						<span class="input-group-text">만원</span>
					</div>
				</div>
			...
			<div class="col-md-6 mb-3">
				<div class="input-group">
					...
					<input type="number" class="form-control" id="priorityDeposit"
						name="priorityDeposit" placeholder="미입력 시 기본값" value="">
					<div class="input-group-append">
						<span class="input-group-text">만원</span>
					</div>
				</div>
			...
			<div class="col-md-6 mb-3">
				<div class="input-group">
					...
					<input type="number" class="form-control" id="leaseRoom"
						name="leaseRoom" placeholder="소액보증금 계산용" value="">
					<div class="input-group-append">
						<span class="input-group-text">개</span>
					</div>
				</div>
	...
	<div class="hiding">
		<div class="mt-4">
			...
			<div class="custom-control custom-checkbox mb-3 d-inline ml-2 nocap">
				<input type="checkbox" id="number" class="custom-control-input"
				...
				<div id="resultSet" style="overflow-x: auto; white-space: nowrap;">
					<div id="result1" class="result pr-4">
						...
						<div class="page-header mb-2">
							<span class="h5">계산서</span>&nbsp; <i class="far fa-copy click"
								onclick="copyTable(this)" aria-hidden="true"></i>&nbsp;&nbsp; <i
								class="fas fa-file-csv click" onclick="downloadCsv(this)"
								aria-hidden="true"></i>
						</div>
						<table id="tb" class="table table-bordered tlf mb-4">
							...
							<tbody>
								<tr>
									<td class="listn">1</td>
									<td class="적요">대출금액
										<div class="dpSm text-muted small">입력값</div>
									</td>
									<td class="금액"></td>
								...
								<tr>
									<td class="listn">3</td>
									<td class="적요">소액보증금
										<div class="dpSm text-muted small">지역별 소액보증금 적용(하단 참조)</div>
									</td>
									<td class="금액"></td>
								...
								<tr>
									<td class="listn">4</td>
									<td class="적요">최우선변제금액
										<div class="dpSm text-muted small">적용 방수(0) × 0원</div>
									</td>
									<td class="금액"></td>
									<td class="비고 dpLg">적용 방수(0) × 0원</td>
								</tr>
								<tr>
									<td class="listn">5</td>
									<td class="적요">대출금액 등
										<div class="dpSm text-muted small">대출금 + 보증금 + 선순위채권 등</div>
									</td>
									<td class="금액"></td>
								...
								<tr style="background-color: #eeefff; font-weight: bold">
									<td class="listn">6</td>
									<td class="적요">LTV
										<div class="dpSm text-muted small">대출금액 등 / 담보가치 × 100</div>
									</td>
									<td class="금액">%</td>
		...
		<div class="hiding" style="display: block;">
			...
			<div id="basisWrap" class="p-3 my-3 alert-info rounded">
				<h5>계산결과 해설</h5>
				<span id="basis"><p>대략적인 지역 구분을 통해 소액임차보증금을 계산하였습니다. 구,
						군, 동에 따라 다를 수도 있으니 아래 지역별 소액임차보증금 표를 보고 부정확한 경우 소액임차보증금을 직접
						입력해주세요.</p>
					<p>
						방 공제는 금융감독원의 은행업감독업무시행세칙에 따라 계산되었습니다. 은행이 선택적으로 적용할 수 있는 규정의 경우 대출
						가능액이 최대한으로 나오는 기준을 적용하여 계산하였습니다. 상세한 내용은 <a href="/wiki/방_공제">위키
							- 방공제</a><a href="/wiki/방_공제" target="_blank"><sup><i
								class="far fa-window-restore" title="새창열기" aria-hidden="true"></i><span
								class="sr-only">새창열기</span></sup></a>를 참고하세요.
					</p>
					<p>기존 대출, 선순위채권, 임차보증금, 소액보증금 등이 차감되지 않은 온전한 담보가치를 기준으로
						계산되었습니다. 해당하는 사항이 전혀 없는지 다시 한번 확인해주시기 바랍니다.</p></span>
			</div>
		</div>
	</div>
