...
<div class="site-mobile-menu site-navbar-target">
		...
		<div class="container">
			<div class="menu-bg-wrap">
				<div class="site-navigation">
					<a href="APT_search.jsp" class="logo m-0 float-start" style="text-decoration: none;"><img src="img/mainlogo.png" style="width: 30px; height: 30px;">&nbsp;&nbsp;Matdongsan</a>
   ...
   <div id="container">
      <div id="rvWrapper">
         <div id="roadview" style="width: 100%; height: 100%;" background-color=#005555></div>
         <!-- 로드뷰를 표시할 div 입니다 -->
         <div id="close" title="로드뷰닫기" onclick="closeRoadview()" style="margin-left: 750px;">
            <span class="img"></span>
         </div>
      </div>
      <div id="mapWrapper" style="margin-left: 170px;">
         ...
         <!-- 지도를 표시할 div 입니다 -->
         <div id="roadviewControl" onclick="setRoadviewRoad()" style="left: 180px;"></div>
      </div>
   </div>

   <!-- 아파트 상세정보  -->
   <form action ="BookmarkCon?apt_name=<%= selectLand.getApt_name()%>
   " method="post">
   <table class="table" style="width:1200px ; margin:130px 180px 10px 10px;" align="right"; z-index="1";>
     <tbody>
    <tr class="info">
      <th style="padding: 1.5rem">아파트
      </th>      
      <td style="padding: 1.5rem"><%=selectLand.getApt_name() %> 
      <input type="submit" id="like_btn" class="btn-like" value = "즐겨찾기">
      </td> 
    </tr>
    <tr>
   ...
   <div>
	...
	%> 
      <table class="table" style="width: 1200px; margin: 130px 180px 10px 10px; text-align : center;"
      align="right" ; z-index="1"; >
        <thead>
          <tr>         
            <th style="padding: 1.5rem; font-size:25px; text-align : right; padding-right: 8rem;">실거래가 그래프</th>                     
          </tr>
        </thead>
        <tbody>
            ...
            <tr>
               ...
               <td>
                  <table class="table table-striped" style="width:450px; height: 200px; margin-top:20px">
                  <thead>
                      <tr>
...
<script type="text/javascript">
   ...
   mapOption = {
      center : new kakao.maps.LatLng(<%=selectLand.getApt_geo() %>), // 지도의 중심좌표
      level : 3
   // 지도의 확대 레벨
   };
   ...
   var markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize, imageOption),
       markerPosition = new kakao.maps.LatLng(<%=selectLand.getApt_geo() %>); // 마커가 표시될 위치입니다
   ...
   function displayPlaces1(places) {
      ...
      for (var i = 0; i < places.length; i++) {
         ...
         // 마커를 생성하고 지도에 표시합니다
         var placePosition = new kakao.maps.LatLng(places[i].y, places[i].x), marker = addMarker1(
   ...
   var mapCenter = new kakao.maps.LatLng(<%=selectLand.getApt_geo() %>), // 지도의 중심좌표
   mapOption = {
