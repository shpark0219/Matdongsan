...
<body>
         ...
         <div class="menu-bg-wrap">
            <div class="site-navigation">
               ...
               <ul
                  ...
                  <li class="CalcLand.jsp"><a>부동산계산기</a>
   ...
   <div class="hero page-inner overlay"
      style="background-image: url('images/hero_bg_1.jpg'); height: 1400px;">
      <div class="container">
   ...
   <div style="float: right; margin-top:35px">
      ...
      <div class="InfoBox">
         ...
         LTV, DTI 비율이 다르며 고가주택(시가9억원 초과) 에 따라서도 LTV, DTI 비율을 다릅니다.</p><br><br>
         <p style="text-align:left;font-size:12px;line-height: 22px;">*LTV는 은행들이 주택을 담보로 대출을 해줄 때 적용하는 것으로, 담보가치 대비 최대 대출 가능한도를 의미한다.
         <br>*DTI란 금융기관이 대출자의 연간 소득을 기준으로 얼마나 대출금을 상환할 수 있는지를 판단하는 것이다.</P>
      </div>
...
<!-- 결과값 테이블  -->
   ...
   <div>
      <button onclick="Calcltv()" style=" color: #fff; background-color: #005555; 
       border-radius:10px; font-size: medium; width: 100px;
       ">계산하기</button>
   </div>
   </div>
            </div>
